    ...
    <footer class="page-footer">
      ...
      <div class="footer-nav">
        <div class="container clearfix">
          ...
          <div class="footer-nav__col footer-nav__col--contacts">
            ...
            Head Office: Campus Bazar.<br>
            Madani Avenue, UIU Dhaka.
          </address>
            <div class="phone">
              Telephone:
              <a class="phone__number" href="tel:012345678900">012345678900</a>
            </div>
            <div class="email">
              Email:
              <a href="csami222002@bsds.uiu.ac.bd" class="email__addr">csami222002@bsds.uiu.ac.bd</a>
            </div>
          </div>
      ...
      <div class="page-footer__subline">
        <div class="container clearfix">
          ...
          <div class="copyright">
            &copy; <?php echo date("Y");?> Campus Bazar&trade;
          </div>

          <div class="developer">
            Developed by Sami El-Senor
          </div>

          <div class="designby">
            Design by El-Senor Productions
          </div>
